    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-4">
      ...
      {!added ? (
        <Card className="gap-4">
          ...
          <CardContent className="flex flex-col gap-3">
            <Textarea value={text} onChange={(e) => { setText(e.target.value); setErr(null) }} rows={6} placeholder="https://qizhang.top/learning/#/import/…  or  { &quot;target&quot;: … }" className="font-mono text-xs" data-testid="import-text" />
